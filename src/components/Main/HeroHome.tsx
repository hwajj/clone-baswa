...
import { slideContentsData } from "@/components/Main/slideContentsData";
import HeroHomeSlideContent from "@/components/Main/HeroHomeSlideContent";
import Bullet from "@/components/Main/HeroHomeBullets";
import "@/scss/components/MainContent/HeroHome.scss";
interface HeroHomeProps {
  mainRef: React.RefObject<HTMLElement>;
}
export default function HeroHome({ mainRef }: HeroHomeProps) {
